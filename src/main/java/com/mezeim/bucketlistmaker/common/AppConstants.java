...
public class AppConstants {
    ...
    public static final String REQUEST_HEADER_TOKEN = "SessionIdToken";
    public static final String BUCKET_DOCUMENT = "BUCKET";
    public static final String USER_BUCKET_DOCUMENT = "USER-BUCKET";
    public static final int INVITE_CODE_LEN = 9;
